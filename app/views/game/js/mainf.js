...
function create(){
    ...
    // ghost
    ghost  =this.physics.add.sprite(spawnplayer.x+227, spawnplayer.y+242, 'player').setVelocity(-40, 49).setBounce(1,1).setOrigin(0.5, 0.5);
    this.physics.add.collider(ghost, layer2);
    
    ghost1  =this.physics.add.sprite(spawnplayer.x+150, spawnplayer.y+153, 'player').setVelocity(35, -53).setBounce(1,1).setOrigin(0.5, 0.5);
